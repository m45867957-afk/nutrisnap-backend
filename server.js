...
app.use(
  cors({
    origin: (origin, callback) => {
      ...
      // origin "null" پیش می‌آید وقتی صفحه‌ای مستقیم از روی فایل (file://) باز شده باشد،
      // مثل ابزار مدیریت محلی — چون اندپوینت‌های ادمین با رمز محافظت می‌شوند، اجازه‌اش می‌دهیم.
